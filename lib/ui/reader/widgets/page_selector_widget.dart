...
class PageSelectorWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<EpubReaderCubit, EpubReaderState>(
      ...
      builder: (context, state) {
        if (state.chapterContent.listPages.isNotEmpty) {
